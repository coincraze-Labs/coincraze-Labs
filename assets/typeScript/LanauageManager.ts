...
export class LanauageManager {
    ...
    public static truncateString(str: string, maxLength: number = 15, type:number = 1): string {  
        ...
        if (type == 1){
            ...
            showStr = str.substring(0, 4) + '...' + str.substring(str.length - 4, 4);
        }
        return showStr
    } 
